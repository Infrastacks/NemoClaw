...
exports.azureOpenAIProvider = {
    ...
    async resolveEndpointUrl(ctx) {
        ...
        if (!input) {
            input = await (0, prompt_js_1.promptInput)("Azure OpenAI resource name or URL (e.g., my-resource or https://my-resource.openai.azure.com)");
        }
        if (!input)
            return "";
    ...
    async discoverModels(apiKey, endpointUrl) {
        const result = await (0, validate_js_1.validateApiKey)(apiKey, endpointUrl, (0, validate_js_1.azureValidateOptions)(apiKey, endpointUrl));
